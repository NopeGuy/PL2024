class FiniteStateAutomaton:
    def __init__(self):
        ...
        self.transitions = {'ON': {'0': 'ON', '1': 'ON', '2': 'ON', '3': 'ON', '4': 'ON', '5': 'ON', '6': 'ON', '7': 'ON', '8': 'ON', '9': 'ON', '+': 'OFF', '-': 'OFF', '=': 'PRINT'},
            ...
            if 'on' in three_chars:
                ...
                if self.current_state == 'ON' and input_text[i].isdigit():
                    ...
                    if numbers:
                        ...
                        i += len(numbers) - 1 # Increment counter by number of digits found (minus 1, since the loop will increment it)
